...
// add listeners
addition.on('error', function(event) { console.log( 'err', event) })
...
division.add('arb-division', arb.division, {onCycle: arb.cleanDiv})
...
// add listeners
division.on('error', function(event) { console.log( 'err', event) })
division.on('cycle', function(event) { console.log( 'wt', event);console.log(String(event.target)) })
